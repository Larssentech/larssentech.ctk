...
public interface CTKSettings {
	...
	public static final String VERSION = "NX CTK v.1.6 (20221124 M2)";
	...
	public static final String OTHER_USERS_PUB_KEY_LIB = CTKSettings.HOME_DIR + CTKSettings.SEP + "nxrsa_pub_key_lib";
