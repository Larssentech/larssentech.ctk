...
// public interface EmbeddedSettings {
// 
...
// 
// 	public static final String OWN_RSA_DIR = ".xkserver_rsa";
...
// 
// 	public static final String OTHER_USERS_PUB_KEY_LIB = EmbeddedSettings.HOME_DIR + EmbeddedSettings.SEP + "nxrsa_pub_key_lib";
// 	public static final String SETTINGS_PATH = EmbeddedSettings.HOME_DIR + EmbeddedSettings.SEP + EmbeddedSettings.OWN_RSA_DIR + EmbeddedSettings.SEP + "nxctk.ini";
